...
const COLOR = '#16a34a'
const PRODUCT_NAME = 'TrailDay'
const PRODUCT_INITIAL = 'T'
const COOKIE = 'tra'
const ITEM_NAME = 'Onboardings'
...
const Logo = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="50" cy="50" r="42" fill="url(#td1)"/>
    ...
    <path d="M22 72 L35 62" stroke="white" strokeWidth="3" strokeLinecap="round" opacity="0.5"/>
    <path d="M65 62 L78 72" stroke="white" strokeWidth="3" strokeLinecap="round" opacity="0.5"/>
  </svg>
)
  ...
  const Sidebar = () => (
    <div style={{width:220,background:'linear-gradient(180deg,#0a0f2e 0%,#0f172a 100%)',display:'flex',flexDirection:'column',padding:'20px 12px',height:'100vh',position:'sticky',top:0,flexShrink:0,overflowX:'hidden'}}>
      ...
      <div style={{marginTop:'auto',borderTop:'1px solid rgba(255,255,255,0.06)',paddingTop:14}}>
        ...
        <button onClick={() => { document.cookie='tra_token=;max-age=0'; document.cookie='tra_user=;max-age=0'; router.push('/login') }}
